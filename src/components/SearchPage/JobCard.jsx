...
function JobCard({ postedTime, title, paymentVerified,  location, hourlyRate,  estimatedTime, description }) {
  return (
    <article className="flex z-10 flex-col items-start px-4 pt-14 pb-10 mt-px w-full text-sm leading-loose bg-white text-stone-500 max-md:max-w-full">
      ...
      <div className="mt-6 leading-6 text-neutral-900 max-md:max-w-full">
        {description}
      </div>
    </article>
  );
